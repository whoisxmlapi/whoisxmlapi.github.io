...
public class BulkWhoisApiSample {
    ...
    static String user = "Bulk Whois Api username",pass="password",fmt="json";
    static String[] dom = {"threatintelligenceplatform.com", "google.com"};

    public static void main(String[] args) throws Exception {
        JSONObject arg=new JSONObject().put("maxRecords",dom.length); int err;
    ...
    private static JSONObject api(String uri,JSONObject arg) throws Exception{
        ...
        arg.put("username",user).put("password",pass).put("outputFormat",fmt);
        rq.setEntity(new org.apache.http.entity.StringEntity(arg.toString()));
        String r=client.execute(rq,new BasicResponseHandler());client.close();
