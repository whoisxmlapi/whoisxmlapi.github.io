...
Please, refer to
[Domain Availability API User Guide](https://domain-availability.whoisxmlapi.com/api/documentation/making-requests) for
...
```c#
{% include_relative assets/samples/domain.availability/net/DomainAvailabilityApi.cs %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```java
{% include_relative assets/samples/domain.availability/java/DomainAvailabilityApi.java %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```html
{% include_relative assets/samples/domain.availability/js/domain.avail.html %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```js
{% include_relative assets/samples/domain.availability/nodejs/domain.avail.js %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```php
{% include_relative assets/samples/domain.availability/php/domain.avail.php %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```perl
{% include_relative assets/samples/domain.availability/perl/domain.avail.pl %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```posh
{% include_relative assets/samples/domain.availability/powershell/domain.avail.ps1 %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```python
{% include_relative assets/samples/domain.availability/python/domain.avail.py %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```ruby
{% include_relative assets/samples/domain.availability/ruby/domain.avail.rb %}
```
</div>
</div>
