...
```c#
{% include_relative assets/samples/dns.lookup/net/ApiKeyDnsApi.cs %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```java
{% include_relative assets/samples/dns.lookup/java/ApiKeyDNSQuery.java %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```html
{% include_relative assets/samples/dns.lookup/js/dns_lookup_apikey.html %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```js
{% include_relative assets/samples/dns.lookup/nodejs/dns_lookup_apikey.js %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```php
{% include_relative assets/samples/dns.lookup/php/dns_lookup_apikey.php %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```perl
{% include_relative assets/samples/dns.lookup/perl/dns_lookup_apikey.pl %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```posh
{% include_relative assets/samples/dns.lookup/powershell/dns_lookup_apikey.ps1 %}
```
</div>
</div>
...
<div class="container-fluid" markdown="1"> 
```python
{% include_relative assets/samples/dns.lookup/python/dns_lookup_apikey.py %}
```
</div>
</div>
